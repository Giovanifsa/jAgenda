 ...
 * "Pouca precisão, e com desempenho pior."
 * TODO: Resolver imprecisão do timer.
 */
public class TimerSimples {
    //Nomeador de threads
    private static int INSTANCIAS_GERADAS = 0;
    ...
    public void iniciar() {
        ...
        thread = new Thread("TimerSimples - Instacia " + instancia) {
            @Override
            public void run() {
                long tempobuf;
